...
config = {
    "seed": 42,
    "dataset": "yahoo",
    "train_csv_path": "datasets/Yahoo-10k-train/yahoo-10k-train.csv",
    "train_feather_path": "datasets/Yahoo-10k-train/Yahoo-10k-train-bert-noise/yahoo-10k-train_LLM.feather",
    "train_data_column": "text",
    "train_label_column": "label",
    "test_csv_path": "datasets/yahoo-2k5-testset/yahoo_answers-test-2k5.csv",
